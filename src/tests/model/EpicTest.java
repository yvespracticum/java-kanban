...
class EpicTest {
    ...
    @Test void testEpicConstructorWithId() {
    ...
    @Test void testDeleteSubtaskFromMyList() {
        epic.addToMySubtasks(1);
        epic.addToMySubtasks(2);
    ...
    @Test void testClearMySubtasksIdsList() {
        epic.addToMySubtasks(1);
        epic.addToMySubtasks(2);
